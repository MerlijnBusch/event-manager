...
class RolePolicy
{
    ...
    public function read(User $user) {
        return in_array(Permissions::__READ_ROLE__, json_decode($user->role->permissions, 1));
    }
    ...
    public function write(User $user) {
        return in_array(Permissions::__WRITE_ROLE__, json_decode($user->role->permissions, 1));
    }
}
