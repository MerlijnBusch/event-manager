<template>
    <form class="form" id="app" action="/" method="post" @submit.prevent="AccountVerification">
        ...
        <h5>
            In uw e-mail postvak vind u een bericht met een activatielink. Geen bericht ontvangen van ons? Vul dan hier uw e-mailadres in om de activatielink opnieuw te sturen naar uw emailadres.
        </h5>
