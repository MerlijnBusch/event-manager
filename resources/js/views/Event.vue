                        ...
                        <template v-for="congress in data.congress">
                            ...
                            >
                                <div class="event-congress-round-content">
                                    ...
                                    <template
                                        v-for="keynote in round.items.filter(
                                            s => s.type === 'keynotes'
                                        )"
                                    >
                                        <b
            ...
            >
                ...
                >
                    <template v-if="subscribed">
                        <div>
                            Je bent al ingeschreven, als je aanpassingen wilt
                            maken moet je eerst uitschrijven
                        </div>
...
export default {
    ...
    methods: {
        ...
        async subscribeEvent () {
            const selectedIDs = [
                ...this.selectedSpeakers.filter(v => !!v).map(v => v.id),
                ...this.selectedKeyNotes.filter(v => !!v).map(v => v.id)
            ];
