<template>
    <div class="profile-container">
            ...
            <div class="mobile-wrapper flex-grid column-desktop-full column-tablet-12">
                <div class="column-desktop-4 column-tablet-12 column-mobile-12 profile-border profile-main-wrapper">
                    ...
                    <div class="profile-main">
                        ...
                        >
                        <button @click.prevent="showCV" v-if="!edit && !!cvString && cvString.length">
                            bekijk CV
                        </button>
                    </div>
                </div>
        ...
        <div class="cv-holder" ref="cvHolder" @click="emptyCV"></div>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            ...
            showCV(){
                let numPages = 0;
                let _this = this;
                let typedArray = Uint8Array.from(atob(this.cvString), c => c.charCodeAt(0));
